                ...
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        ...
                        @foreach($pagos as $pago)
                            @if($pago->fecha_cancelado == null && $pago->prestamo && $pago->prestamo->cliente)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <a href="https://wa.me/{{ $pago->prestamo->cliente->celular }}?text=Hola cliente, {{ $pago->prestamo->cliente->apellidos . ' ' . $pago->prestamo->cliente->nombres }}, usted tiene una cuota atrasada. Por favor realice el pago lo más pronto posible. Atte: {{ $configuracion->nombre ?? 'Su empresa' }}"
